...
urlpatterns = [
    ...
    path(r'cultural/<sub_program>/history', program_views.cultural_program),
    path(r'entertainment/<sub_program>/', program_views.cultural_program),
    path(r'entertainment/<sub_program>/history', program_views.cultural_program),
